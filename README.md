...
5. Now we can go to https://github.com/HackYourFuture-CPH/ov-class09-fp and create a PR that merges `cookies-popup` into `develop`. This PR is really nice, check it out: https://github.com/HackYourFuture-CPH/ov-class09-fp/pull/89
